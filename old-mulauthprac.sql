...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 01, 2020 at 03:17 PM
...
(3, 'Admin', 'admin@gmail.com', NULL, '$2y$10$avei.tKdW/dzMhMN30Gijet1WbHp0WXzbeLsAQE6XhBDpWfywP9mq', 'Md. Faysal', 'Ahamed', '2/3 New circular Road,West Malibagh,Dhaka-1217', '01710021328', '105734sir.jpg', NULL, '2020-02-16 14:44:04', '2020-02-16 16:57:34');
...
(1, '9', 'gaag', 'gag', '<p>gag</p>', '<p>agag</p>', '<p>gaga</p>', '<p>gag</p>', 'gagg', 'gagag', 'gag', 'gag', 'gaga', '101531like (1).svg', '101531like (1).svg', '101531pen.svg', '101531like (1) (1).svg', '101531pen.svg', '101531like (1).svg', '101531clock.svg', '101531clock.svg', '101531pen.svg', '101531clock.svg', 0, '2020-03-01 16:15:31', '2020-03-01 16:15:31'),
(2, '15', 'Clipping Path Service', 'Sell more products online with product photos edited to convert.', '<p><span style=\"color: rgb(44, 60, 98); font-family: &quot;Josefin Sans&quot;, sans-serif; font-size: 20px; text-align: center;\">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia aspernatur, dolor eius assuum, dosnerspiciatis unde! Mollitia, saepe vel.</span></p>', '<p><q style=\"font-size: 5rem; color: rgb(0, 155, 151); font-family: &quot;Great Vibes&quot;, cursive; text-align: center;\">First job with them went without a hitch. Clipping paths of good quality&nbsp;</q><br style=\"color: rgb(51, 51, 51); font-family: sans-serif; font-size: 17.5px; text-align: center;\"><cite style=\"color: rgb(0, 155, 151); font-family: &quot;Great Vibes&quot;, cursive; font-size: 4.5rem; text-align: center;\">— attention to detail</cite></p>', '<div class=\"content\" style=\"color: rgb(51, 51, 51); font-family: sans-serif; font-size: 14px;\"><div class=\"content-context text-center\"><blockquote style=\"margin-bottom: 20px; padding: 10px 20px; font-size: 17.5px; border-left: 5px solid rgb(238, 238, 238);\"><q style=\"font-size: 5rem; color: rgb(0, 155, 151); font-family: &quot;Great Vibes&quot;, cursive;\">Excellent, their clipping is absolutely perfect. Happy with results and customer service!</q><br></blockquote><div><q style=\"font-size: 5rem; color: rgb(0, 155, 151); font-family: &quot;Great Vibes&quot;, cursive;\"><br></q></div></div></div>', '<div class=\"content-header\" style=\"color: rgb(51, 51, 51); font-family: sans-serif; font-size: 14px;\"><h2 class=\"content-title\" style=\"margin-top: 20px; margin-bottom: 10px; line-height: 1.1; font-size: 30px; font-family: inherit; color: rgb(51, 73, 124);\">Clipping Path India help section</h2></div><h3 style=\"margin-top: 20px; margin-bottom: 10px; line-height: 1.1; font-size: 24px; font-family: &quot;Josefin Sans&quot;, sans-serif; color: rgb(51, 73, 124); padding-top: 10px; padding-bottom: 10px;\">What is clipping path ?</h3><p style=\"color: rgb(44, 60, 98); font-family: &quot;Josefin Sans&quot;, sans-serif; margin-right: 0px; margin-bottom: 10px; margin-left: 0px; padding-top: 10px; padding-bottom: 10px;\"></p><h3 style=\"margin-top: 20px; margin-bottom: 10px; line-height: 1.1; font-size: 24px; font-family: &quot;Josefin Sans&quot;, sans-serif; color: rgb(51, 73, 124); padding-top: 10px; padding-bottom: 10px;\">What is image background removal?</h3><p style=\"color: rgb(44, 60, 98); font-family: &quot;Josefin Sans&quot;, sans-serif; margin-right: 0px; margin-bottom: 10px; margin-left: 0px; padding-top: 10px; padding-bottom: 10px;\">Background removal is isolating the subject of a photo or image and wiping the rest of the image clean. This accomplishes a cleaner, simpler look and emphasizes the subject of the image. Background removal services are commonly used in the ecommerce space. Product photos with white backgrounds have become the industry norm, and many popular online marketplaces require white backgrounds.</p><p style=\"color: rgb(44, 60, 98); font-family: &quot;Josefin Sans&quot;, sans-serif; margin-right: 0px; margin-bottom: 10px; margin-left: 0px; padding-top: 10px; padding-bottom: 10px;\">Image background removal is not only for white backgrounds, though. You can also add a single-color background, or add a â€œcontextualâ€� background.</p><div class=\"row\" style=\"color: rgb(51, 51, 51); font-family: sans-serif; font-size: 14px;\"><div class=\"col-lg-6 col-md-6 col-sm-12 col-xs-12\" style=\"width: 495px; min-height: 1px; float: left;\"><h3 style=\"margin-top: 20px; margin-bottom: 10px; line-height: 1.1; font-size: 24px; font-family: &quot;Josefin Sans&quot;, sans-serif; color: rgb(51, 73, 124); padding-top: 10px; padding-bottom: 10px;\">How to remove the background from an image</h3><p style=\"color: rgb(44, 60, 98); font-family: &quot;Josefin Sans&quot;, sans-serif; margin-right: 0px; margin-bottom: 10px; margin-left: 0px; font-size: 16px; padding-top: 10px; padding-bottom: 10px;\">There is no one way to remove the background from an image. It all depends on what the subject of the image is and how advanced the photo editorâ€™s skills are. At Clipping Path India, we mostly use clipping path to achieve image background removal, but there are also instances where weâ€™ll use advanced Photoshop masking, such as when the image has hair or fur.</p><h3 style=\"margin-top: 20px; margin-bottom: 10px; line-height: 1.1; font-size: 24px; font-family: &quot;Josefin Sans&quot;, sans-serif; color: rgb(51, 73, 124); padding-top: 10px; padding-bottom: 10px;\">Clipping path background removal:</h3><p style=\"color: rgb(44, 60, 98); font-family: &quot;Josefin Sans&quot;, sans-serif; margin-right: 0px; margin-bottom: 10px; margin-left: 0px; font-size: 16px; padding-top: 10px; padding-bottom: 10px;\">Hand-drawn clipping paths will achieve the best result with natural-looking lines that will enhance the realistic qualities of your product photos. Use the Pen Tool in Photoshop to remove the background, and donâ€™t forget to zoom in so you capture the smallest details.</p><h3 style=\"margin-top: 20px; margin-bottom: 10px; line-height: 1.1; font-size: 24px; font-family: &quot;Josefin Sans&quot;, sans-serif; color: rgb(51, 73, 124); padding-top: 10px; padding-bottom: 10px;\">Advanced Photoshop background removal:</h3><p style=\"color: rgb(44, 60, 98); font-family: &quot;Josefin Sans&quot;, sans-serif; margin-right: 0px; margin-bottom: 10px; margin-left: 0px; font-size: 16px; padding-top: 10px; padding-bottom: 10px;\">If you have hair or fur in the photo, play around with some of the Photoshop tools and techniques available to you. The background eraser tool, magic eraser tool and the color separation technique â€” or a combination of more than one â€” can all help you achieve a photo that will make shoppers want to buy your products.</p><p style=\"color: rgb(44, 60, 98); font-family: &quot;Josefin Sans&quot;, sans-serif; margin-right: 0px; margin-bottom: 10px; margin-left: 0px; font-size: 16px; padding-top: 10px; padding-bottom: 10px;\">If youâ€™re doing the background removal yourself, itâ€™s important to remember to remain consistent with the other product photos on your website or seller profile. And especially if youâ€™re selling on a third-party site like Amazon or eBay, itâ€™s essential to abide by their product photo guidelines. (Weâ€™ve created a&nbsp;<a href=\"http://127.0.0.1:8000/bg-removal-srvices\" style=\"color: rgb(51, 122, 183);\">reference to product photo requirements for online marketplaces&nbsp;</a>to get you started.)</p><p style=\"color: rgb(44, 60, 98); font-family: &quot;Josefin Sans&quot;, sans-serif; margin-right: 0px; margin-bottom: 10px; margin-left: 0px; font-size: 16px; padding-top: 10px; padding-bottom: 10px;\">When you want to add some color to the background, consider how those colors may affect online shoppers. Are they complementary to the colors of the product? Will they persuade shoppers to buy? Do they resonate with your brand? You might also need to add color to the background of white or transparent products.</p><p style=\"color: rgb(44, 60, 98); font-family: &quot;Josefin Sans&quot;, sans-serif; margin-right: 0px; margin-bottom: 10px; margin-left: 0px; font-size: 16px; padding-top: 10px; padding-bottom: 10px;\"><a href=\"http://127.0.0.1:8000/bg-removal-srvices\" style=\"color: rgb(51, 122, 183);\">Learn how to remove the background from an image with hair &gt;</a></p></div><div class=\"col-lg-6 col-md-6 col-sm-12 col-xs-12\" style=\"width: 495px; min-height: 1px; float: left;\"><img src=\"http://127.0.0.1:8000/assets/frontend_asset/svg/polo-shirt.svg\" alt=\"\" style=\"border: 0px; padding-top: 50px; width: 465px; height: 300px;\">&nbsp;<img src=\"http://127.0.0.1:8000/assets/frontend_asset/svg/teddy-bear.svg\" alt=\"\" style=\"border: 0px; padding-top: 50px; width: 465px; height: 300px;\">&nbsp;<img src=\"http://127.0.0.1:8000/assets/frontend_asset/svg/desk.svg\" alt=\"\" style=\"border: 0px; padding-top: 50px; width: 465px; height: 300px;\"></div></div><h3 style=\"margin-top: 20px; margin-bottom: 10px; line-height: 1.1; font-size: 24px; font-family: &quot;Josefin Sans&quot;, sans-serif; color: rgb(51, 73, 124); padding-top: 10px; padding-bottom: 10px;\">Who needs image background removal services?</h3><p style=\"color: rgb(44, 60, 98); font-family: &quot;Josefin Sans&quot;, sans-serif; margin-right: 0px; margin-bottom: 10px; margin-left: 0px; padding-top: 10px; padding-bottom: 10px;\">In short, any ecommerce retailer can benefit from image background removal services. Itâ€™s a tedious task to undertake, especially on large batches of images. Attention to detail is essential to achieving edited photos that look realistic and will convince consumers to purchase.</p><p style=\"color: rgb(44, 60, 98); font-family: &quot;Josefin Sans&quot;, sans-serif; margin-right: 0px; margin-bottom: 10px; margin-left: 0px; padding-top: 10px; padding-bottom: 10px;\">Image background removal allows ecommerce companies to isolate the product and remove any distractions from the frame. It also helps create a uniform, consistent look to all product photos on your site. This, in turn, creates a predictable and easy user interface that will help online consumers view and purchase your products.</p><p style=\"color: rgb(44, 60, 98); font-family: &quot;Josefin Sans&quot;, sans-serif; margin-right: 0px; margin-bottom: 10px; margin-left: 0px; padding-top: 10px; padding-bottom: 10px;\">Thereâ€™s a use for image background removal in print, too. Catalogs have a clean, consistent look free of distractions. If youâ€™re creating technical documentation or user manuals, you can remove irrelevant subjects from the image and create visuals that complement the words on the page. This helps customers use your product more easily.</p><p style=\"color: rgb(44, 60, 98); font-family: &quot;Josefin Sans&quot;, sans-serif; margin-right: 0px; margin-bottom: 10px; margin-left: 0px; padding-top: 10px; padding-bottom: 10px;\">Whether you have a single image or a huge batch from your latest photoshoot, professional photo background removal services can help you focus on what really matters in your business: moving the needle.</p><h3 style=\"margin-top: 20px; margin-bottom: 10px; line-height: 1.1; font-size: 24px; font-family: &quot;Josefin Sans&quot;, sans-serif; color: rgb(51, 73, 124); padding-top: 10px; padding-bottom: 10px;\">When to use background removal</h3><ul style=\"margin-bottom: 10px; color: rgb(51, 51, 51); font-family: sans-serif; font-size: 14px;\"><li style=\"font-size: 18px; font-family: &quot;Josefin Sans&quot;, sans-serif;\">To comply with requirements of online marketplaces, such as Amazon and eBay</li><li style=\"font-size: 18px; font-family: &quot;Josefin Sans&quot;, sans-serif;\">When the background is distracting or takes focus away from the subject of the image</li><li style=\"font-size: 18px; font-family: &quot;Josefin Sans&quot;, sans-serif;\">Showcase the details of your product and make it stand out</li><li style=\"font-size: 18px; font-family: &quot;Josefin Sans&quot;, sans-serif;\">Draw attention to an object in the foreground</li><li style=\"font-size: 18px; font-family: &quot;Josefin Sans&quot;, sans-serif;\">If you need to isolate and show specific features of a product or object</li><li style=\"font-size: 18px; font-family: &quot;Josefin Sans&quot;, sans-serif;\">Create a uniform background on multiple images, such as a product catalog or ecommerce store</li><li style=\"font-size: 18px; font-family: &quot;Josefin Sans&quot;, sans-serif;\">To achieve a transparent background</li></ul><h3 style=\"margin-top: 20px; margin-bottom: 10px; line-height: 1.1; font-size: 24px; font-family: &quot;Josefin Sans&quot;, sans-serif; color: rgb(51, 73, 124); padding-top: 10px; padding-bottom: 10px;\">When not to use background removal</h3><ul style=\"margin-bottom: 10px; color: rgb(51, 51, 51); font-family: sans-serif; font-size: 14px;\"><li style=\"font-size: 18px; font-family: &quot;Josefin Sans&quot;, sans-serif;\">The existing background provides great context for the object</li><li style=\"font-size: 18px; font-family: &quot;Josefin Sans&quot;, sans-serif;\">If you can use lighting and backdrops to create white background product photos when you shoot</li></ul><h3 style=\"margin-top: 20px; margin-bottom: 10px; line-height: 1.1; font-size: 24px; font-family: &quot;Josefin Sans&quot;, sans-serif; color: rgb(51, 73, 124); padding-top: 10px; padding-bottom: 10px;\">Image background removal services at Clipping Path India</h3><p style=\"color: rgb(44, 60, 98); font-family: &quot;Josefin Sans&quot;, sans-serif; margin-right: 0px; margin-bottom: 10px; margin-left: 0px; padding-top: 10px; padding-bottom: 10px;\">After testing a variety of tools and techniques, we have found that we can achieve the best-looking product photos with clipping path or advanced Photoshop masking. We continuously test new techniques and tools to make sure weâ€™re using the latest and most advanced methods.</p><p style=\"color: rgb(44, 60, 98); font-family: &quot;Josefin Sans&quot;, sans-serif; margin-right: 0px; margin-bottom: 10px; margin-left: 0px; padding-top: 10px; padding-bottom: 10px;\">Our professionally trained graphic designers have years of experience in providing image background removal services. Weâ€™re masters of Photoshopâ€™s Pen Tool, which allows us to define highly precise clipping paths. We zoom in to your images by as much as 300% when drawing each clipping path. This enables us to have sufficient anchor points to retain the natural shape of the object. Having too many or too few anchor points can result in an inadequate photo cut-out and images that donâ€™t look lifelike. Unlike many other photo background removal services, we do everything by hand. We also avoid using tools like Magic Wand for quick selection and path creation. Weâ€™ve seen, firsthand, the results of automations and tools and how it can hurt your reputation and your brand.</p><p style=\"color: rgb(44, 60, 98); font-family: &quot;Josefin Sans&quot;, sans-serif; margin-right: 0px; margin-bottom: 10px; margin-left: 0px; padding-top: 10px; padding-bottom: 10px;\">Todayâ€™s consumers demand quality, and so do we at Clipping Path India. We pride ourselves on the quality of the finished product â€” no matter how many images you need edited.</p>', 'service-1', 'service-2', 'service-3', 'Service Name', 'Service Description', '134452blog-view.PNG', '111009teddy-bear.svg', '111009action-blur-car-child.jpg', '111009action-blur-car-child-386009.jpg', '111009balance-blur-boulder-close-up-355863.jpg', '111009accessory-bag-briefcase-buckle-1152077.jpg', '134927clock.svg', '111009clock.svg', '111009desk.svg', '111009pen.svg', 1, '2020-03-01 17:10:09', '2020-03-01 19:49:27'),
(3, '9', 'hasdhha', 'hahah', '<p>hadhdah</p>', '<p>hahdah</p>', '<p>haha</p>', '<p>haha</p>', 'ahdhdah', 'hahah', 'ha', 'haha', 'haha', '140941clock.svg', '140941clock.svg', '140941desk.svg', '140941clock.svg', '140941like (1) (1).svg', '140941like (1).svg', '140941like (1).svg', '140941teddy-bear.svg', '140941desk.svg', '140941like (1) (1).svg', 0, '2020-03-01 20:09:41', '2020-03-01 20:09:41');
...
(1, '<h2 style=\"margin-top: 20px; margin-bottom: 10px; line-height: 1.1; padding: 3rem 3rem 0px;\">Committed to making the world a better place</h2>', '<p><span style=\"color: rgb(51, 51, 51); font-family: &quot;Josefin Sans&quot;, sans-serif; font-size: 20px; text-align: center;\">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Non, error saepe et sint mollitia esse cum quasi, perferendis, minima expedita tempore architecto facilis sunt optio.</span></p>', '050959relationship.svg', '2020-02-22 11:01:21', '2020-02-22 15:06:26');
...
--
-- Table structure for table `cpservice`
--

CREATE TABLE `cpservice` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `top_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `top_des_side_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ur_wrk_actn_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cnt_img_one` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cnt_img_two` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cnt_img_three` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reltd_srvs_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cps_top_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `top_img_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `brows_help_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `try_ur_srv_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `why_cp_bd_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rltd_srv_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rltd_srv_one` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rltd_srv_two` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rltd_srv_three` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rltd_srv_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content_des` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ibrs_top_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ibrs_top_des_side_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ibrs_ur_wrk_actn_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ibrs_cnt_img_one` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ibrs_cnt_img_two` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ibrs_cnt_img_three` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ibrs_reltd_srvs_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ibrs_page_top_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ibrs_top_img_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ibrs_brows_help_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ibrs_try_ur_srv_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ibrs_why_cp_bd_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ibrs_content_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ibrs_rltd_srv_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ibrs_rltd_srv_one` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ibrs_rltd_srv_two` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ibrs_rltd_srv_three` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ibrs_rltd_srv_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ibrs_content_des` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ims_top_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ims_top_des_side_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ims_ur_wrk_actn_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ims_cnt_img_one` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ims_cnt_img_two` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ims_cnt_img_three` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ims_reltd_srvs_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ims_page_top_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ims_top_img_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ims_brows_help_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ims_try_ur_srv_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ims_why_cp_bd_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ims_content_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ims_rltd_srv_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ims_rltd_srv_one` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ims_rltd_srv_two` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ims_rltd_srv_three` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ims_rltd_srv_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ims_content_des` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dss_top_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dss_top_des_side_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dss_ur_wrk_actn_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dss_cnt_img_one` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dss_cnt_img_two` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dss_cnt_img_three` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dss_reltd_srvs_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dss_page_top_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dss_top_img_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dss_brows_help_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dss_try_ur_srv_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dss_why_cp_bd_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dss_content_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dss_rltd_srv_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dss_rltd_srv_one` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dss_rltd_srv_two` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dss_rltd_srv_three` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dss_rltd_srv_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dss_content_des` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gmpe_top_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gmpe_top_des_side_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gmpe_ur_wrk_actn_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gmpe_cnt_img_one` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gmpe_cnt_img_two` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gmpe_cnt_img_three` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gmpe_reltd_srvs_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gmpe_page_top_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gmpe_top_img_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gmpe_brows_help_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gmpe_try_ur_srv_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gmpe_why_cp_bd_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gmpe_content_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gmpe_rltd_srv_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gmpe_rltd_srv_one` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gmpe_rltd_srv_two` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gmpe_rltd_srv_three` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gmpe_rltd_srv_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gmpe_content_des` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cvcc_top_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cvcc_top_des_side_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cvcc_ur_wrk_actn_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cvcc_cnt_img_one` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cvcc_cnt_img_two` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cvcc_cnt_img_three` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cvcc_reltd_srvs_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cvcc_page_top_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cvcc_top_img_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cvcc_brows_help_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cvcc_try_ur_srv_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cvcc_why_cp_bd_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cvcc_content_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cvcc_rltd_srv_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cvcc_rltd_srv_one` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cvcc_rltd_srv_two` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cvcc_rltd_srv_three` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cvcc_rltd_srv_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cvcc_content_des` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prs_top_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prs_top_des_side_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prs_ur_wrk_actn_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prs_cnt_img_one` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prs_cnt_img_two` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prs_cnt_img_three` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prs_reltd_srvs_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prs_page_top_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prs_top_img_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prs_brows_help_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prs_try_ur_srv_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prs_why_cp_bd_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prs_content_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prs_rltd_srv_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prs_rltd_srv_one` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prs_rltd_srv_two` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prs_rltd_srv_three` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prs_rltd_srv_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prs_content_des` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ppe_top_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ppe_top_des_side_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ppe_ur_wrk_actn_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ppe_cnt_img_one` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ppe_cnt_img_two` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ppe_cnt_img_three` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ppe_reltd_srvs_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ppe_page_top_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ppe_top_img_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ppe_brows_help_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ppe_try_ur_srv_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ppe_why_cp_bd_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ppe_content_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ppe_rltd_srv_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ppe_rltd_srv_one` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ppe_rltd_srv_two` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ppe_rltd_srv_three` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ppe_rltd_srv_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ppe_content_des` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vcs_top_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vcs_top_des_side_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vcs_ur_wrk_actn_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vcs_cnt_img_one` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vcs_cnt_img_two` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vcs_cnt_img_three` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vcs_reltd_srvs_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vcs_page_top_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vcs_top_img_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vcs_brows_help_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vcs_try_ur_srv_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vcs_why_cp_bd_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vcs_content_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vcs_rltd_srv_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vcs_rltd_srv_one` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vcs_rltd_srv_two` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vcs_rltd_srv_three` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vcs_rltd_srv_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vcs_content_des` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `cpservice`
--

INSERT INTO `cpservice` (`id`, `top_img`, `top_des_side_img`, `ur_wrk_actn_img`, `cnt_img_one`, `cnt_img_two`, `cnt_img_three`, `reltd_srvs_img`, `cps_top_title`, `top_img_title`, `brows_help_des`, `try_ur_srv_des`, `why_cp_bd_des`, `content_title`, `rltd_srv_title`, `rltd_srv_one`, `rltd_srv_two`, `rltd_srv_three`, `rltd_srv_des`, `content_des`, `ibrs_top_img`, `ibrs_top_des_side_img`, `ibrs_ur_wrk_actn_img`, `ibrs_cnt_img_one`, `ibrs_cnt_img_two`, `ibrs_cnt_img_three`, `ibrs_reltd_srvs_img`, `ibrs_page_top_title`, `ibrs_top_img_title`, `ibrs_brows_help_des`, `ibrs_try_ur_srv_des`, `ibrs_why_cp_bd_des`, `ibrs_content_title`, `ibrs_rltd_srv_title`, `ibrs_rltd_srv_one`, `ibrs_rltd_srv_two`, `ibrs_rltd_srv_three`, `ibrs_rltd_srv_des`, `ibrs_content_des`, `ims_top_img`, `ims_top_des_side_img`, `ims_ur_wrk_actn_img`, `ims_cnt_img_one`, `ims_cnt_img_two`, `ims_cnt_img_three`, `ims_reltd_srvs_img`, `ims_page_top_title`, `ims_top_img_title`, `ims_brows_help_des`, `ims_try_ur_srv_des`, `ims_why_cp_bd_des`, `ims_content_title`, `ims_rltd_srv_title`, `ims_rltd_srv_one`, `ims_rltd_srv_two`, `ims_rltd_srv_three`, `ims_rltd_srv_des`, `ims_content_des`, `dss_top_img`, `dss_top_des_side_img`, `dss_ur_wrk_actn_img`, `dss_cnt_img_one`, `dss_cnt_img_two`, `dss_cnt_img_three`, `dss_reltd_srvs_img`, `dss_page_top_title`, `dss_top_img_title`, `dss_brows_help_des`, `dss_try_ur_srv_des`, `dss_why_cp_bd_des`, `dss_content_title`, `dss_rltd_srv_title`, `dss_rltd_srv_one`, `dss_rltd_srv_two`, `dss_rltd_srv_three`, `dss_rltd_srv_des`, `dss_content_des`, `gmpe_top_img`, `gmpe_top_des_side_img`, `gmpe_ur_wrk_actn_img`, `gmpe_cnt_img_one`, `gmpe_cnt_img_two`, `gmpe_cnt_img_three`, `gmpe_reltd_srvs_img`, `gmpe_page_top_title`, `gmpe_top_img_title`, `gmpe_brows_help_des`, `gmpe_try_ur_srv_des`, `gmpe_why_cp_bd_des`, `gmpe_content_title`, `gmpe_rltd_srv_title`, `gmpe_rltd_srv_one`, `gmpe_rltd_srv_two`, `gmpe_rltd_srv_three`, `gmpe_rltd_srv_des`, `gmpe_content_des`, `cvcc_top_img`, `cvcc_top_des_side_img`, `cvcc_ur_wrk_actn_img`, `cvcc_cnt_img_one`, `cvcc_cnt_img_two`, `cvcc_cnt_img_three`, `cvcc_reltd_srvs_img`, `cvcc_page_top_title`, `cvcc_top_img_title`, `cvcc_brows_help_des`, `cvcc_try_ur_srv_des`, `cvcc_why_cp_bd_des`, `cvcc_content_title`, `cvcc_rltd_srv_title`, `cvcc_rltd_srv_one`, `cvcc_rltd_srv_two`, `cvcc_rltd_srv_three`, `cvcc_rltd_srv_des`, `cvcc_content_des`, `prs_top_img`, `prs_top_des_side_img`, `prs_ur_wrk_actn_img`, `prs_cnt_img_one`, `prs_cnt_img_two`, `prs_cnt_img_three`, `prs_reltd_srvs_img`, `prs_page_top_title`, `prs_top_img_title`, `prs_brows_help_des`, `prs_try_ur_srv_des`, `prs_why_cp_bd_des`, `prs_content_title`, `prs_rltd_srv_title`, `prs_rltd_srv_one`, `prs_rltd_srv_two`, `prs_rltd_srv_three`, `prs_rltd_srv_des`, `prs_content_des`, `ppe_top_img`, `ppe_top_des_side_img`, `ppe_ur_wrk_actn_img`, `ppe_cnt_img_one`, `ppe_cnt_img_two`, `ppe_cnt_img_three`, `ppe_reltd_srvs_img`, `ppe_page_top_title`, `ppe_top_img_title`, `ppe_brows_help_des`, `ppe_try_ur_srv_des`, `ppe_why_cp_bd_des`, `ppe_content_title`, `ppe_rltd_srv_title`, `ppe_rltd_srv_one`, `ppe_rltd_srv_two`, `ppe_rltd_srv_three`, `ppe_rltd_srv_des`, `ppe_content_des`, `vcs_top_img`, `vcs_top_des_side_img`, `vcs_ur_wrk_actn_img`, `vcs_cnt_img_one`, `vcs_cnt_img_two`, `vcs_cnt_img_three`, `vcs_reltd_srvs_img`, `vcs_page_top_title`, `vcs_top_img_title`, `vcs_brows_help_des`, `vcs_try_ur_srv_des`, `vcs_why_cp_bd_des`, `vcs_content_title`, `vcs_rltd_srv_title`, `vcs_rltd_srv_one`, `vcs_rltd_srv_two`, `vcs_rltd_srv_three`, `vcs_rltd_srv_des`, `vcs_content_des`, `created_at`, `updated_at`) VALUES
(2, '120114group-of-people-sitting-on-sofa-while-discussing-2962135.jpg', '120114boy-and-girl-sitting-on-bench-toy-1767434.jpg', '075508action-blur-car-child.jpg', '120114polo-shirt.svg', '075508131801relationship.svg', '120114teddy-bear.svg', '120114relationship.svg', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '121453adult-books-business-coffee-374016.jpg', '131801boy-and-girl-sitting-on-bench-toy-1767434.jpg', '075508action-blur-car-child.jpg', '131801polo-shirt.svg', '131801relationship.svg', '131801teddy-bear.svg', '051159131801relationship.svg', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '061720person-in-beige-top-on-mountain-cliff-1134188.jpg', '133735boy-and-girl-sitting-on-bench-toy-1767434.jpg', '070952action-blur-car-child-386009.jpg', '133735polo-shirt.svg', '133735relationship.svg', '133735teddy-bear.svg', '070414131801relationship.svg', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '134320group-of-people-sitting-on-sofa-while-discussing-2962135.jpg', '134320boy-and-girl-sitting-on-bench-toy-1767434.jpg', '074436action-blur-car-child.jpg', '134320polo-shirt.svg', '075320131801relationship.svg', '134320teddy-bear.svg', '074436action-blur-car-child-386009.jpg', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '134747person-in-beige-top-on-mountain-cliff-1134188.jpg', '134747boy-and-girl-sitting-on-bench-toy-1767434.jpg', '075405action-blur-car-child.jpg', '134747relationship.svg', '134747teddy-bear.svg', '134747polo-shirt.svg', '075405action-blur-car-child-386009.jpg', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '135025group-of-people-sitting-on-sofa-while-discussing-2962135.jpg', '135025boy-and-girl-sitting-on-bench-toy-1767434.jpg', '075405action-blur-car-child.jpg', '135025relationship.svg', '135025teddy-bear.svg', '135025polo-shirt.svg', '075405131801relationship.svg', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '135403multicolored-abstract-painting-1012982.jpg', '135403boy-and-girl-sitting-on-bench-toy-1767434.jpg', '075441134320polo-shirt.svg', '135403polo-shirt.svg', '135403relationship.svg', '135403teddy-bear.svg', '075441131801relationship.svg', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '135714multicolored-abstract-painting-1266808.jpg', '135714boy-and-girl-sitting-on-bench-toy-1767434.jpg', '075441131801relationship.svg', '135714polo-shirt.svg', '135714relationship.svg', '135714teddy-bear.svg', '075441action-blur-car-child.jpg', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '140052selective-photograph-of-a-wall-with-grafitti-1194420.jpg', '140052boy-and-girl-sitting-on-bench-toy-1767434.jpg', '074027action-blur-car-child.jpg', '140052polo-shirt.svg', '140052relationship.svg', '140052teddy-bear.svg', '074006131801relationship.svg', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-25 18:01:14', '2020-03-01 15:52:12');
...
(15, '<h2 style=\"margin-top: 20px; margin-bottom: 10px; line-height: 1.1;\">Clipping path</h2>', '<p><font color=\"#337ab7\" face=\"Josefin Sans, sans-serif\"><span style=\"background-color: rgb(255, 255, 255); font-size: 20px; text-align: center;\">38% of consumers</span></font><span style=\"color: rgb(51, 51, 51); font-family: &quot;Josefin Sans&quot;, sans-serif; font-size: 20px; text-align: center;\">&nbsp;want to see product photos with white backgrounds, but editing all those images takes a ton of time. Clipping Path India’s hand-drawn clipping path image-editing services save valuable time you could be using to grow your business and generate more revenue.</span></p>', '123712test.jpg', '2020-02-20 18:35:43', '2020-02-20 18:37:12'),
(16, '<h2 style=\"margin-top: 20px; margin-bottom: 10px; line-height: 1.1;\">Drop shadow</h2>', '<p><span style=\"color: rgb(51, 51, 51); font-family: &quot;Josefin Sans&quot;, sans-serif; font-size: 20px; text-align: center;\">Drop shadow services help your products pop off the screen and come to life for potential buyers. Taking steps to create a shadow effect that enhances the consumer experience requires time-consuming, skillful work.</span></p>', '123756bag.jpg', '2020-02-20 18:35:50', '2020-02-20 18:37:56'),
(17, '<h2 style=\"margin-top: 20px; margin-bottom: 10px; line-height: 1.1;\">Ghost mannequin</h2>', '<p><span style=\"color: rgb(51, 51, 51); font-family: &quot;Josefin Sans&quot;, sans-serif; font-size: 20px; text-align: center;\">A mannequin requires a one-time investment, whereas live models can be expensive. Not to mention, ghost mannequins are easier to style and fit. But consumers want to see products on real people — and that’s where the ghost mannequin comes in.</span></p>', '123851balance-blur-boulder-close-up-355863.jpg', '2020-02-20 18:35:55', '2020-02-20 18:38:51');
...
(6, 'Vector conversion', 1, '2020-02-29 17:26:08', '2020-01-19 06:05:14'),
...
(15, 'Clipping Path', 1, '2020-02-29 17:24:36', '2020-01-29 12:09:13');
...
CREATE TABLE `servicepage` (
  ...
  `page_top_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cp_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `br_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `im_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ds_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gm_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cv_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pr_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ppe_img` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `page_top_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `page_top_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `top_img_under_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sec_three_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cp_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cp_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `br_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `br_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sec_four_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `im_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `im_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ds_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ds_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sec_five_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gm_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gm_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cv_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cv_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sec_six_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pr_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pr_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pre_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pre_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sec_seven_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `servicepage` (`id`, `page_top_img`, `cp_img`, `br_img`, `im_img`, `ds_img`, `gm_img`, `cv_img`, `pr_img`, `ppe_img`, `page_top_title`, `page_top_des`, `top_img_under_des`, `sec_three_title`, `cp_title`, `cp_des`, `br_title`, `br_des`, `sec_four_des`, `im_title`, `im_des`, `ds_title`, `ds_des`, `sec_five_des`, `gm_title`, `gm_des`, `cv_title`, `cv_des`, `sec_six_des`, `pr_title`, `pr_des`, `pre_title`, `pre_des`, `sec_seven_des`, `created_at`, `updated_at`) VALUES
(1, '041807text-on-shelf-256417.jpg', '041807desk.svg', '041807like (1) (1).svg', '041807like (1).svg', '041807pen.svg', '041807pentagon.svg', '041807polo-shirt.svg', '041807relationship.svg', '041807teddy-bear.svg', 'Clipping Path Bangladesh Image-Editing Services', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ad repellendus earum molestias debitis aspernatur sunt, explicabo sed architecto aperiam beatae. Doloremque in doloribus', '<q style=\"font-size: 5rem; color: rgb(0, 155, 151); font-family: &quot;Great Vibes&quot;, cursive; text-align: center;\">MAZING! Great communication, fast response, and even faster service. Thank you so much for the great business and service.</q><br style=\"color: rgb(51, 51, 51); font-family: sans-serif; font-size: 17.5px; text-align: center;\"><cite style=\"color: rgb(0, 155, 151); font-family: &quot;Great Vibes&quot;, cursive; font-size: 4.5rem; text-align: center;\">–Hassian</cite>', 'gs', 'gsgs', 'gsg', 'gsg', 'gsg', '<q style=\"font-size: 5rem; color: rgb(0, 155, 151); font-family: &quot;Great Vibes&quot;, cursive; text-align: center;\">Awesome service, low pricing, professional work, quick turnaround. Excellent customer service not typically found today. They will take care of your needs and keep you moving to your timeline!</q><br style=\"color: rgb(51, 51, 51); font-family: sans-serif; font-size: 17.5px; text-align: center;\"><cite style=\"color: rgb(0, 155, 151); font-family: &quot;Great Vibes&quot;, cursive; font-size: 4.5rem; text-align: center;\">–Scott Perry</cite>', 'gsg', 'gsg', 'gs', 'gsg', '<q style=\"font-size: 5rem; color: rgb(0, 155, 151); font-family: &quot;Great Vibes&quot;, cursive; text-align: center;\">helpful with all my quotes, questions and turnaround time. Quality of work was excellent. I will be using Clipping Path India from now on.</q><br style=\"color: rgb(51, 51, 51); font-family: sans-serif; font-size: 17.5px; text-align: center;\"><cite style=\"color: rgb(0, 155, 151); font-family: &quot;Great Vibes&quot;, cursive; font-size: 4.5rem; text-align: center;\">–Melissa</cite>', 'gsg', 'gsg', 'gsgs', 'gsg', '<p><q style=\"font-size: 5rem; color: rgb(0, 155, 151); font-family: &quot;Great Vibes&quot;, cursive; text-align: center;\">MAZING! Great communication, fast response, and even faster service. Thank you so much for the great business and service.</q><br style=\"color: rgb(51, 51, 51); font-family: sans-serif; font-size: 17.5px; text-align: center;\"><cite style=\"color: rgb(0, 155, 151); font-family: &quot;Great Vibes&quot;, cursive; font-size: 4.5rem; text-align: center;\">–Hassian</cite></p>', 'gsg', 'gs', 'gsg', 'gs', '<p><q style=\"font-size: 5rem; color: rgb(0, 155, 151); font-family: &quot;Great Vibes&quot;, cursive; text-align: center;\">I have to say, your team is amazing! Everything is done so fast, and so professionally. The quality of work on the images we submitted was perfect.</q><br style=\"color: rgb(51, 51, 51); font-family: sans-serif; font-size: 17.5px; text-align: center;\"><cite style=\"color: rgb(0, 155, 151); font-family: &quot;Great Vibes&quot;, cursive; font-size: 4.5rem; text-align: center;\">--Nicholas Scalice</cite></p>', '2020-03-01 10:18:07', '2020-03-01 10:27:47');
...
(2, '<p>HLW</p>', '<p>Ditels</p>', '100026person-holding-midnight-black-samsung-galaxy-s8-turn-on-near-1092671.jpg', '#8080ff', '2020-02-19 11:11:49', '2020-02-23 13:44:20');
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `first_name`, `last_name`, `company`, `address`, `city`, `country`, `profile_img`, `zip`, `phone`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Ali Saheb', 'user@gmail.com', NULL, '$2y$10$PL0uocvUQNtk0YyAvIYPaOfDVmj1vWTfCRQY8tIdyqCf49xgxEhuW', 'ali', 'saheb', 'GGI', '2/3 New circular Road,West Malibagh,Dhaka-1217', 'Dhaka', 'Bangladesh', '055756ali.jpg', '1217', '01710021328', NULL, '2020-01-20 00:43:51', '2020-02-18 11:51:18'),
(3, 'Suranur', 'ohidujjamanfahad987@gmail.com', NULL, '$2y$10$d4Z/KQ1zKVIKi0qtG0vAku4p4XzmRRYJHLdmQRxUJl5YAFV32clmi', '', '', '', '', '', '', '', '', '', NULL, '2020-02-10 22:55:39', '2020-02-10 22:55:39'),
(4, 'Suhanur', 'shuhanshuvo85@gmail.com', NULL, '$2y$10$qexcAdTq9tCtgektmR.XOeNnLzTWPk6pDALK45oeLAA.KNmcG7VG2', '', '', '', '', '', '', '', '', '', NULL, '2020-02-10 23:23:08', '2020-02-10 23:23:08'),
(5, 'test', 'test@gmail.com', NULL, '$2y$10$5wvou4KL3SSPa81bR9gcpuIedbWu6YHEfvRWXscKevuJPzcac0mFG', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-17 19:11:10', '2020-02-17 19:11:10'),
(6, 'Jubayer', 'orphanjubu@gmail.com', NULL, '$2y$10$5YuO5UtXsiShvch/6RYNu.bT6bsF/99Z5M.PLcsbjB7KH7uzuBiM6', NULL, NULL, NULL, NULL, NULL, NULL, '054601Capture.PNG', NULL, NULL, NULL, '2020-02-19 11:42:23', '2020-02-19 11:46:01');
...
--
-- Indexes for table `cpservice`
--
ALTER TABLE `cpservice`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `cpservice`
--
ALTER TABLE `cpservice`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
