...
<main class="app-content">
   <div class="app-title">
      <div>
         <h1><i class="fa fa-edit"></i> Create  Service</h1>
      </div>
   </div>
   <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
              	<form action="{{ route('servicepage.store') }}" class="row" method="post" enctype="multipart/form-data">
            	@csrf
		        ...
		        <div class="form-group col-md-4">
	                <label class="col-md-4 control-label"><strong> Page Title </strong></label><br>
	               	<input type="text" name="page_title" class="form-control" required="required">
                </div> 
                <div class="form-group col-md-2">
                  <label class="control-label"><strong>Page IMG</strong></label>
                  <input class="form-control" name="page_img" type="file" placeholder="" required="required">
                </div> 
                <div class="form-group col-md-4">
	                <label class="col-md-4 control-label"><strong> Page IMG TEXT </strong></label><br>
	               	<input type="text" name="page_img_text"  class="form-control" required="required">
                </div> 
                <div class="form-group col-md-12">
	                <label class="col-md-12 control-label"><strong>Page img under des </strong></label><br>
	               	<textarea cols="60" rows="1" name="page_img_under_des" id="" class="form-control" required="required"></textarea>
                </div> 
                <div class="form-group col-md-2">
                ...
                <div class="form-group col-md-2">
                  ...
                  <input class="form-control" name="our_wrk_actn_img_one" type="file" placeholder=" " required="required">
                </div>
                <div class="form-group col-md-2">
                  <label class="control-label"><strong>our work action img-2</strong></label>
                  <input class="form-control" name="our_wrk_actn_img_two" type="file" placeholder=" " required="required">
                </div>
                <div class="form-group col-md-2">
                  <label class="control-label"><strong>our work action img-3</strong></label>
                  <input class="form-control" name="our_wrk_actn_img_three" type="file" placeholder=" " required="required">
                </div>
                <div class="form-group col-md-2">
                  <label class="control-label"><strong>our work action img-4</strong></label>
                  <input class="form-control" name="our_wrk_actn_img_four" type="file" placeholder=" " required="required">
                </div>
                 <div class="form-group col-md-12">
	                <label class="col-md-12 control-label"><strong>Try our service under Description </strong></label><br>
	               	<textarea cols="60" rows="1" name="try_our_service_under_des" id="destwo" class="form-control" required="required"></textarea>
                </div>
                <div class="form-group col-md-12">
	                <label class="col-md-12 control-label"><strong>Why cpbd under Description </strong></label><br>
	               	<textarea cols="60" rows="1" name="why_cpbd_under_des" id="desthree" class="form-control" required="required"></textarea>
                </div>
                <div class="form-group col-md-12">
	                <label class="col-md-12 control-label"><strong>Page content Description </strong></label><br>
	               	<textarea cols="60" rows="1" name="page_content_des" id="desfour" class="form-control" required="required"></textarea>
                </div> 
                 <div class="form-group col-md-4">
	                <label class="col-md-4 control-label"><strong> Related service-1 </strong></label><br>
	               	<input type="text" name="related_srvc_one"  class="form-control" required="required">
                </div>  
                <div class="form-group col-md-4">
	                <label class="col-md-4 control-label"><strong> Related service-2 </strong></label><br>
	               	<input type="text" name="related_srvc_two"  class="form-control" required="required">
                </div>  
                <div class="form-group col-md-4">
	                <label class="col-md-4 control-label"><strong> Related service-3 </strong></label><br>
	               	<input type="text" name="related_srvc_three"  class="form-control" required="required">
                </div> 
                <div class="form-group col-md-2">
                  <label class="control-label"><strong>Related service IMG</strong></label>
                  <input class="form-control" name="related_srvc_img" type="file" placeholder=" " required="required">
                </div>
                <div class="form-group col-md-4">
	                <label class="col-md-6 control-label"><strong> Related service Name </strong></label><br>
	               	<input type="text" name="related_srvc_name"  class="form-control" required="required">
                </div> 
                <div class="form-group col-md-12">
	                <label class="col-md-12 control-label"><strong>Related service Des </strong></label><br>
	               	<textarea cols="60" rows="1" name="related_srvc_des" id="desone" class="form-control" required="required"></textarea>
                </div> 
                <div class="form-group col-md-2">
                  <label class="control-label"><strong>Page sample img-1</strong></label>
                  <input class="form-control" name="page_sample_img_one" type="file" placeholder=" " required="required">
                </div>
                <div class="form-group col-md-2">
                  <label class="control-label"><strong>Page sample img-2</strong></label>
                  <input class="form-control" name="page_sample_img_two" type="file" placeholder=" " required="required">
                </div> 
                <div class="form-group col-md-2">
                  <label class="control-label"><strong>Page sample img-3</strong></label>
                  <input class="form-control" name="page_sample_img_three" type="file" placeholder=" " required="required">
                </div>
                <div class="form-group">
	               <label for="exampleSelect1">Publication Status*</label>
	               <select class="form-control" id="exampleSelect1" name="publication_status" required="required">
